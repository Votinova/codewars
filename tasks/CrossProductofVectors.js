...
Создайте функцию под названием crossProductкоторый принимает два трехмерных вектора (в виде двух массивов) и возвращает их векторное произведение. Вам необходимо проверить, имеют ли переданные аргументы ожидаемый формат, в противном случае throwсообщение: «Аргументы не являются трехмерными векторами!».

crossProduct([1,0,0],[0,1,0]) //should return [0,0,1]
crossProduct('gobbledigook', [1,1,1]) //should throw the string "Arguments are not 3D vectors!"

Ваша функция должна обрабатывать нецелые числа.

Дополнительная информация о перекрестных продуктах: https://en.wikipedia.org/wiki/Cross_product .
